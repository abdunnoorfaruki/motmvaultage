 ...
 * Inline so it loads instantly and stays sharp on retina. To swap to
 * the official PNG, replace this with:
 *   <Image src="/assets/logo.png" alt="M.O.T.M. Vaultage" width={36} height={36} />
 */
